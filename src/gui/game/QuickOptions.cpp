...
DrawWiresOption::DrawWiresOption(GameModel* m) :
	QuickOption("W", "Draw Circuit Wires \bg(C)", m, Toggle)
{

}
bool DrawWiresOption::GetToggle()
{
	return m->GetDrawWiresEnable();
}
void DrawWiresOption::perform()
{
	m->SetDrawWiresEnable(!m->GetDrawWiresEnable());
}
