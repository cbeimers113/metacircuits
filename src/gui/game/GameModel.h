...
private:
	...
	//When loading a stamp with circuits, remember the filename to load the associated circuit file
	ByteString circuitID;
...
public:
	...
	bool GetDrawWiresEnable();
	void SetDrawWiresEnable(bool drawWires);
	...
	void SetCircuitID(ByteString id);
	ByteString GetCircuitID();
