...
ELEMENT_DEFINE(DIGI, 187);
ELEMENT_DEFINE(DIOD, 188);
ELEMENT_DEFINE(AND, 189);
ELEMENT_DEFINE(OR, 190);
ELEMENT_DEFINE(NOT, 191);
ELEMENT_DEFINE(NAND, 192);
ELEMENT_DEFINE(NOR, 193);
ELEMENT_DEFINE(XOR, 194);
ELEMENT_DEFINE(XNOR, 195);
ELEMENT_DEFINE(BUFR, 196);
ELEMENT_DEFINE(JOIN, 197);
ELEMENT_DEFINE(LED, 198);
ELEMENT_DEFINE(TRNS, 199);
